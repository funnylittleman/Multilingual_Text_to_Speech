    ...
    for epoch in range(max(0, last_epoch), a.training_epochs):
        ...
        for i, batch in enumerate(train_loader):
            if rank == 0:
                start_b = time.time()
            x, y, _, y_mel = batch
            x, y, y_mel = x.float(), y.float(), y_mel.float()
...
def main():
    ...
    parser.add_argument('--input_wavs_dir', default='ft_dataset')
    parser.add_argument('--input_mels_dir', default='ft_dataset')
    parser.add_argument('--input_training_file', default='ft_dataset/training.txt')
    parser.add_argument('--input_validation_file', default='ft_dataset/validation.txt')
    parser.add_argument('--checkpoint_path', default='checkpoints/finetuning')
    parser.add_argument('--config', default='checkpoints/finetuning/config.json')
